...
export const buttonVariants = cva(
    'active:scale-95 inline-flex items-center justify-center rounded-md font-medium transition-color fous:outline focus:ring-2 focus:ring-offset-2 disabled:opacity-50 dark:focus:ring-slate-400 disabled:pointer-event-none dark:focus:ring-offset-slate-900', {
    variants: {
        variant: {
